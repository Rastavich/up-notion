...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-e412d2aa.js",
      css: ["/./_app/assets/start-a8cd1609.css"],
      js: ["/./_app/start-e412d2aa.js", "/./_app/chunks/vendor-82bb4997.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = {"src/routes/__layout.svelte": {"entry": "/./_app/pages/__layout.svelte-9c4fdd4f.js", "css": ["/./_app/assets/pages/__layout.svelte-d4883a00.css"], "js": ["/./_app/pages/__layout.svelte-9c4fdd4f.js", "/./_app/chunks/vendor-82bb4997.js"], "styles": null}, ".svelte-kit/build/components/error.svelte": {"entry": "/./_app/error.svelte-c9ff7a97.js", "css": [], "js": ["/./_app/error.svelte-c9ff7a97.js", "/./_app/chunks/vendor-82bb4997.js"], "styles": null}, "src/routes/index.svelte": {"entry": "/./_app/pages/index.svelte-a486dd9a.js", "css": ["/./_app/assets/pages/index.svelte-d5586e33.css"], "js": ["/./_app/pages/index.svelte-a486dd9a.js", "/./_app/chunks/vendor-82bb4997.js"], "styles": null}};
...
var Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<header class="${"svelte-1twf6mk"}"><div class="${"corner svelte-1twf6mk"}"><a href="${"https://kit.svelte.dev"}" class="${"svelte-1twf6mk"}"><img${add_attribute("src", logo, 0)} alt="${"SvelteKit"}" class="${"svelte-1twf6mk"}"></a></div>
	...
	<nav class="${"svelte-1twf6mk"}"><svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-1twf6mk"}"><path d="${"M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z"}" class="${"svelte-1twf6mk"}"></path></svg>
		<ul class="${"svelte-1twf6mk"}"><li class="${["svelte-1twf6mk", $page.path === "/" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-1twf6mk"}">Home</a></li></ul>
...
var trans = writable2([]);
var dbId = "72ed0bc8a5c24fde86b8e13f4589f465";
JSON.stringify({
  parent: {
    database_id: `${dbId}`
  },
...
var UP_API_URL = "up:yeah:j9bfSpjgpnwvjFzawbgcvSRaNV77S07LeBwmt5eXrmga5JmiGK7cXjm6M8EkmLhKfIBwpZRc7mASr5GtBmhVlWjOV42iAYjsTnOUFffbYPSaPAoeGdhA5UxmaH66RglY";
async function send({data, method, token, url}) {
  ...
  return fetch(url + `${token.params}`, opts).then((r) => r.text()).then((json) => {
    try {
...
var AddToNotion = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $$unsubscribe_trans;
  $$unsubscribe_trans = subscribe(trans, (value) => value);
  $$unsubscribe_trans();
  return `<section><button>Add transactions to Notion</button></section>`;
});
var css$1 = {
  code: ".container.svelte-1oxx3q2{display:grid;grid-template-columns:auto auto;margin-top:2rem}ul.svelte-1oxx3q2{padding:0;list-style-type:none;margin-block-end:0;margin-right:5rem}li.svelte-1oxx3q2{box-sizing:border-box}",
  map: `{"version":3,"file":"getTransactions.svelte","sources":["getTransactions.svelte"],"sourcesContent":["<script>\\n  import { onMount } from 'svelte';\\n  import AddToNotion from '$lib/Components/addToNotion.svelte';\\n  import { trans } from '$lib/transactionStore.js';\\n  import { UP_API_URL } from '$lib/variables.js';\\n  let transactions = [];  \\n\\n  import * as api from '$lib/api.js';\\n    import {\\n        respond\\n    } from '$lib/respond.js';\\n\\n  onMount(async () => {\\n    const url = 'https://thingproxy.freeboard.io/fetch/https://api.up.com.au/api/v1/accounts/582be906-8f42-41c6-8177-b53d295c1343/';\\n    const body = await api.get(\\n    {token: UP_API_URL, params: 'transactions?filter[category]=groceries'},\\n    url)\\n   \\n    const accountDetails = await respond(body);\\n    const { body: { data } } = accountDetails;\\n\\n    console.log(data)\\n\\n    transactions = data;\\n\\n    trans.set(transactions);\\n   \\n  });\\n\\n</script>\\n\\n<div class=\\"container\\">\\n  {#await transactions}\\n    <h1>....Loading transactions </h1>\\n  {:then}\\n    {#each transactions as transaction}\\n      <ul>\\n        <li>\\n          {transaction.attributes.description}&nbsp; Amount:\\n          {transaction.attributes.amount.value}\\n        </li>\\n      </ul>\\n    {/each}\\n    <AddToNotion />\\n  {/await}\\n</div>  \\n\\n\\n<style>\\n  .container {\\n    display: grid;\\n    grid-template-columns: auto auto;\\n    margin-top: 2rem;\\n  }\\n  p {\\n    margin-left: 10px;\\n    margin-right: 10px;\\n  }\\n  ul {\\n    padding: 0;\\n    list-style-type: none;\\n    margin-block-end: 0;\\n    margin-right: 5rem;\\n  }\\n  li {\\n    box-sizing: border-box;\\n  }\\n  button {\\n    margin-top: 3rem;\\n  }\\n</style>\\n\\n"],"names":[],"mappings":"AAiDE,UAAU,eAAC,CAAC,AACV,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,IAAI,CAAC,IAAI,CAChC,UAAU,CAAE,IAAI,AAClB,CAAC,AAKD,EAAE,eAAC,CAAC,AACF,OAAO,CAAE,CAAC,CACV,eAAe,CAAE,IAAI,CACrB,gBAAgB,CAAE,CAAC,CACnB,YAAY,CAAE,IAAI,AACpB,CAAC,AACD,EAAE,eAAC,CAAC,AACF,UAAU,CAAE,UAAU,AACxB,CAAC"}`
};
var GetTransactions = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let transactions = [];
  onMount(async () => {
    const url = "https://thingproxy.freeboard.io/fetch/https://api.up.com.au/api/v1/accounts/582be906-8f42-41c6-8177-b53d295c1343/";
    const body = await get({
      token: UP_API_URL,
      params: "transactions?filter[category]=groceries"
    }, url);
    const accountDetails = await respond2(body);
    const {body: {data}} = accountDetails;
    console.log(data);
    transactions = data;
    trans.set(transactions);
  ...
  return `<div class="${"container svelte-1oxx3q2"}">${function(__value) {
  ...
  `;
    return function() {
      return `
    ${each(transactions, (transaction) => `<ul class="${"svelte-1oxx3q2"}"><li class="${"svelte-1oxx3q2"}">${escape2(transaction.attributes.description)}\xA0 Amount:
          ${escape2(transaction.attributes.amount.value)}</li>
      </ul>`)}
    ${validate_component(AddToNotion, "AddToNotion").$$render($$result, {}, {}, {})}
  `;
    }();
  }(transactions)}
</div>`;
...
<section class="${"svelte-mjk9ig"}"><h1 class="${"svelte-mjk9ig"}"><div class="${"welcome svelte-mjk9ig"}"><picture><source srcset="${"svelte-welcome.webp"}" type="${"image/webp"}">
				<img src="${"svelte-welcome.png"}" alt="${"Welcome"}" class="${"svelte-mjk9ig"}"></picture></div></h1>

	${validate_component(GetTransactions, "GetTransactions").$$render($$result, {}, {}, {})}
